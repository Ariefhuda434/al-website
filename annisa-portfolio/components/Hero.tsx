      ...
      <div className="mx-auto grid w-full max-w-6xl items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
        <div>
          <motion.p
            ...
            className="glass-soft mb-6 inline-flex items-center gap-2 rounded-full px-5 py-2.5 text-sm font-semibold text-berry"
          >
          ...
          <motion.p
            ...
            className="max-w-2xl text-base md:text-lg leading-relaxed text-berry/70 font-light italic mb-4"
          >
